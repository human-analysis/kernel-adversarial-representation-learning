...
def parse_args():
    ...
    parser.add_argument('--total-classes', type=int, default=None, metavar='', help='number of classes for Tar classification')
    ...
    parser.add_argument('--adverserial-type', type=str, default=None, help='type of adverserial learning')
    parser.add_argument('--kernel', type=str, default=None, help='type of kernel')
    parser.add_argument('--sigma', type=float, default=None, help='variance of Gaussian kernel')
    parser.add_argument('--c', type=float, default=None, help='variance of Gaussian kernel')
    parser.add_argument('--d', type=int, default=None, help='variance of Gaussian kernel')
    parser.add_argument('--model-type-e', type=str, default=None, help='type of network')
    parser.add_argument('--model-type-ea', type=str, default=None, help='type of network')
    parser.add_argument('--model-type-et', type=str, default=None, help='type of network')
    parser.add_argument('--model-type-a', type=str, default=None, help='type of network')
    parser.add_argument('--model-type-t', type=str, default=None, help='type of network')
    parser.add_argument('--variance', type=float, default=None, help='variance of initial weights')
    ...
    parser.add_argument('--model-options-EA', type=json.loads, default={}, metavar='', help='additional model-specific parameters, i.e. \'{"nstack": 1}\'')
    parser.add_argument('--model-options-ET', type=json.loads, default={}, metavar='', help='additional model-specific parameters, i.e. \'{"nstack": 1}\'')
    parser.add_argument('--model-options-A', type=json.loads, default={}, metavar='', help='additional model-specific parameters, i.e. \'{"nstack": 1}\'')
    ...
    parser.add_argument('--loss-type-e', type=str, default=None, help='loss method')
    parser.add_argument('--loss-type-ea', type=str, default=None, help='loss method')
    parser.add_argument('--loss-type-et', type=str, default=None, help='loss method')
    parser.add_argument('--loss-type-a', type=str, default=None, help='loss method')
    parser.add_argument('--loss-type-t', type=str, default=None, help='loss method')
    parser.add_argument('--loss-options-E', type=json.loads, default={}, metavar='', help='loss-specific parameters, i.e. \'{"wsigma": 1}\'')
    parser.add_argument('--loss-options-EA', type=json.loads, default={}, metavar='', help='loss-specific parameters, i.e. \'{"wsigma": 1}\'')
    parser.add_argument('--loss-options-ET', type=json.loads, default={}, metavar='', help='loss-specific parameters, i.e. \'{"wsigma": 1}\'')
    parser.add_argument('--loss-options-A', type=json.loads, default={}, metavar='', help='loss-specific parameters, i.e. \'{"wsigma": 1}\'')
    parser.add_argument('--loss-options-T', type=json.loads, default={}, metavar='', help='loss-specific parameters, i.e. \'{"wsigma": 1}\'')
    parser.add_argument('--evaluation-type-ea', type=str, default=None, help='evaluation method')
    parser.add_argument('--evaluation-type-et', type=str, default=None, help='evaluation method')
    parser.add_argument('--evaluation-type-a', type=str, default=None, help='evaluation method')
    parser.add_argument('--evaluation-type-t', type=str, default=None, help='evaluation method')
    parser.add_argument('--evaluation-options-EA', type=json.loads, default={}, metavar='', help='evaluation-specific parameters, i.e. \'{"topk": 1}\'')
    parser.add_argument('--evaluation-options-ET', type=json.loads, default={}, metavar='', help='evaluation-specific parameters, i.e. \'{"topk": 1}\'')
    parser.add_argument('--evaluation-options-A', type=json.loads, default={}, metavar='', help='evaluation-specific parameters, i.e. \'{"topk": 1}\'')
    ...
    parser.add_argument('--batch-size_e', type=int, default=None, help='batch size for training')
    ...
    parser.add_argument('--nepochs-e', type=int, default=None, help='number of epochs to train')
    ...
    parser.add_argument('--german-seed', type=int, default=None, help='manual seed for German')
    ...
    parser.add_argument('--learning-rate_a', type=float, default=None, help='learning rate')
    parser.add_argument('--learning-rate_t', type=float, default=None, help='learning rate')
    ...
    # ============================ LAMBDA r ===================================================
    # parser.add_argument('--lambd', type=str, default=None, help='privacy-performance trade-off')
    parser.add_argument('--r', type=int, default=None, help='embedding dimension')
    parser.add_argument('--lambd', type=json.loads, default=[0], metavar='', help='embedding dimension')
    parser.add_argument('--iter', type=int, default=None, help='no. of experiments')
    parser.add_argument('--reg', type=float, default=None, help='regularization parameter for projection')
    parser.add_argument('--hdlayers', type=int, default=None, help='hiden layers of encoder')
